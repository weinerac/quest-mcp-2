...
// Create proper MCP server with required metadata
...
// Start server with stdio transport for local development
async function main() {
...
// For Vercel deployment, export the server as a handler
